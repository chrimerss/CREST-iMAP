...
if __name__=='__main__':
    ...
    for i, params in enumerate(param_values):
        ...
        stage_err= metrics(gauges[gauge_name][0].stage.values, sim_H, ['nse','rmse','bias','pearsonr','peak_flow_error','peak_time_error'])
