...
def sample(samples, n, criterion=None, iterations=None, plot=False):
    ...
    A 2-factor design with 5 centered samples::
        ...
        >>> lhs.sample(5, 2, criterion='center')
        array([[ 0.3,  0.5],
               [ 0.7,  0.9],
               [ 0.1,  0.3],
               [ 0.9,  0.1],
    ...
    all samples has been maximized::
        ...
        >>> lhs.sample(4, 3, criterion='maximin')
    ...
    as possible (within 10 iterations)::
        ...
        >>> lhs.sample(5, 4, criterion='correlate', iterations=10)
    ...
    if plot:
        ...
        plt.xlabel('X1')
        plt.ylabel('X2')
        plt.title('Latin Hypercube Sampling \n(random, center, maxmin, centermaxmin, correlate)')
        plt.show()
