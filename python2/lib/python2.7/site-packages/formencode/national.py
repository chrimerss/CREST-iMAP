...
class PostalCodeInCountryFormat(FancyValidator):
    ...
    _vd = {
        ...
        'FO': lambda: DelimitedDigitsPostalCode(3),
        ...
        'SM': lambda: DelimitedDigitsPostalCode(5),
        'US': USPostalCode,
        'UA': lambda: DelimitedDigitsPostalCode(5),
        'UY': lambda: DelimitedDigitsPostalCode(5),
        'VA': lambda: DelimitedDigitsPostalCode(5),
    }
